...
---
## 背景
しばらくぶりに ujina.com ドメインでブログを書こうかと。以前、ひろしまなんとか日記とかいうタイトルのブログをこのドメインでやっていたが、記事を書くよりブログシステムをいじりたおす場になってしまい、そのうち放置。

WordPress から移る静的サイトジェネレーターを探して漂流していた。仕事のサイトを VuePress にして続いているので、いじるの好きでやっていくブログもVuePressがよかろうと。
